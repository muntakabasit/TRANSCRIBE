...
class TranscriptionManager: ObservableObject {
    ...
    func transcribe(audioURL: URL) async {
        ...
        do {
            ...
            // PHASE 1: Use stub data for now
            // TODO: Integrate WhisperKit in Phase 3
            let segments = try await transcribeWithStub(audioURL: audioURL)

            await MainActor.run {
                var transcription = currentTranscription ?? Transcription()
    ...
    // MARK: - WhisperKit Integration (Phase 3 - TODO)
    /*
